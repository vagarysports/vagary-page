    ...
    <>
      ...
      <div className='bg-[#141618] flex flex-col md:flex-row-reverse justify-center items-center py-20 lg:px-20'>
          ...
          <div className='flex-1 p-5 md:p-10 '>
            ...
            <p className='text-justify text-[#DDD] mb-5 text-lg'>Being fully immersed in the professional environment for years, Mike knows the ins and outs of how teams at a high level work and operate. Therefore, Vagary Sports Management aims to provide those standards for every team that comes to our facilities. </p>
          </div>        
      </div>
