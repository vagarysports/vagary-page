    ...
    <>
      ...
      <div className=' bg-center bg-fixed bg-no-repeat bg-cover' style={{ backgroundImage:'url(/images/footer-1.png)' }}>
          <div className='bg-black bg-opacity-70 py-20 lg:py-56  w-full h-full flex flex-col md:flex-row justify-center items-center'>
            ...
            <div className='flex-1 p-5 min-h-[60vh] w-full max-w-[700px] bg-center bg-cover bg-no-repeat' style={{ backgroundImage: 'url(/images/partners1.jpeg)' }}>
      ...
      <div className='w-full flex justify-center'>
        <div className='flex flex-col md:flex-row-reverse justify-center items-center shadow-sm shadow-gray-400 my-80 overflow-hidden rounded-3xl  w-[90%]'>
        <div className='flex-1 w-full relative rounded-r-3xl overflow-hidden bg-center' >
        <div className='w-full bg-orange-50 relative min-h-[300px] min-w-[300px] md:min-h-[500px] bg-center bg-cover bg-no-repeat' style={{ backgroundImage:'url(/images/partners3.jpeg)' }}></div>
      ...
      <div className=' bg-center  bg-fixed bg-no-repeat bg-cover' style={{ backgroundImage:'url(/images/footer-2.png)' }}>
          <div className='py-20 lg:py-56 w-full h-full bg-black bg-opacity-70 flex flex-col md:flex-row-reverse justify-center items-center'>
            ...
            <div className='flex-1 p-5 min-h-[60vh] w-full max-w-[700px] bg-center bg-cover bg-no-repeat' style={{ backgroundImage: 'url(/images/partners2.jpeg)' }}>
