  ...
  return (
    <div className='flex flex-col md:flex-row min-h-screen pt-24 bg-center bg-cover bg-no-repeat' style={{ backgroundImage:'url(/images/contact-bg.png)' }}>
      ...
      <div className='w-full'>
        <h2 className={`mb-20 mt-10 md:mt-0 text-6xl md:text-8xl font-bold w-full text-center md:w-auto md:text-left text-white px-10 ${styles.borderText}`} >Contact Us</h2>
        <ContactForm />
      </div>
    </div>
  )
