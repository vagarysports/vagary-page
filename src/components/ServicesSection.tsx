                ...
                <div className="md:min-w-[430px] w-full  md:w-[40%]" key={item.title+'servicesCards'}>
                    <div className="min-h-[400px] mb-8 rounded-[20px] bg-gray-100 xs:p-10 p-7  shadow-md hover:shadow-lg " >
                        <div className='flex gap-1 items-center flex-col sm:flex-row'>
                            <div className="shrink-0 bg-primary mb-8 flex h-[70px] w-[70px] items-center justify-center rounded-2xl" > 
                            ...
                            <h4 className=" text-dark mb-7 text-base md:text-xl font-semibold lg:text-center text-justify">
                                { item.title }
                            </h4>
                        </div>
