...
const SERVICES = [
    { 
        title:'Trips to Spain for preseason, tournaments or friendly tours (Full detail in VGSM TRAVEL):', 
        description: 'We offer customized trips to Spain, with new facilities completed in 2021, at the highest level. We guarantee high quality competitive matches. The client will have a 100% possibility of customization of the trip, organizing it as he wishes.', 
        icon: ''
    },
    { 
        title:'Legal representation of athletes:', 
        description: 'We represent young talents in their sports career. Our philosophy is to be close to the player and their families to advise and support them throughout their career. We work with transparency and commitment to help our players both on a soccer and personal level.', 
        icon: ''
    },
    { 
        title:'Immersion or qualification trips for coaches (stages from 4 to 36 weeks):', 
        description: 'Thanks to our collaboration with "Construyendo Futbol" we can offer coaches the possibility to travel to Spain from 6 to 36 weeks to learn, get certified in UEFA courses and train with professional teams. In addition, we offer online courses on many aspects of the game made by Construyendo Futbol.', 
        icon: ''
    },
]
    ...
    <div className="mx-auto">
        ...
        <div className="flex flex-wrap">
            {SERVICES.map(item=>(
                ...
                <div
                className="min-h-[400px] mb-8 rounded-[20px] bg-gray-100 p-10 shadow-md hover:shadow-lg md:px-7 xl:px-10"
                >
                <div
